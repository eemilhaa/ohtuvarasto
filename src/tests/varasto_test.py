...
class TestVarasto(unittest.TestCase):
    ...
    def test_uusi_varasto_ei_liian_täyteen(self):
    ...
    def test_liian_suuri_lisays_ei_nosta_saldoa_tilavuuden_yli(self):
    ...
    def test_liian_iso_ottaminen_palauttaa_oikean_maaran(self):
        self.varasto.lisaa_varastoon(8)
